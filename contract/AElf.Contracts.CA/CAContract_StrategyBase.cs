...
//
//
// public abstract class NumericStrategy : Strategy
// {
...
//         }
//         else if(obj is NumericStrategy)
//         {
//             return ((NumericStrategy)obj).ToStrategyNode().ToByteString();
//         }
//
...
//         else if (obj is NumericStrategy)
//         {
//             return ((NumericStrategy)obj).Validate(context);
//         }
//         
//         Assert(false, "obj should be one of a long, a string, or an instance of NumericStrategy.");
//         return null; // untouchable line, just for get rid of red underline masked by IDE.
...
// }
//
// public abstract class BinaryNumericStrategy : NumericStrategy
// {
...
//     {
//         return Compare((long)ValidateStrategyParameter(One, context), (long)ValidateStrategyParameter(Two, context));
//     }
// }
//
...
//     public override object Validate(StrategyContext context)
//     {
//         return Calculate((long)ValidateStrategyParameter(One, context), (long)ValidateStrategyParameter(Two, context));
//     }
// }
